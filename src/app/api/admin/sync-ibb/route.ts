        ...
        cells.each((idx, cell) => {
          ...
          events.push({
            ...
            category: title.toLowerCase().includes("çocuk")
              ...
              : "Tiyatro",
            image:
              "https://images.unsplash.com/photo-1503095396549-807a8bc36675?q=80&w=2070&auto=format&fit=crop",
            source: "IBB",
            externalId: Buffer.from(
              `${title}-${eventDate.getTime()}-${sahneAdi}`
            ).toString("base64"),
